...
const CONTRACT_ADDRESS =
  "0xA0e75967c847e9e3f11a04A0E3f300bBA79AC29a";
    ...
    try {
      ...
      if (ethereum) {
        ...
        connectedContract.on("NewEpicNFTMinted", (from, tokenId) => {
          ...
          alert(
            `あなたのウォレットに NFT を送信しました。Pixxiti に表示されるまで最大で10分かかることがあります。NFT へのリンクはこちらです: https://goerli.pixxiti.com/nfts/${CONTRACT_ADDRESS.toLowerCase()}/${tokenId.toNumber()}`
          );
        });
